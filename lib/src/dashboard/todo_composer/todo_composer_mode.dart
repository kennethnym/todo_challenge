...
class TodoComposerMode with _$TodoComposerMode {
  ...
  const factory TodoComposerMode.hidden() = TodoComposerModeHidden;

  /// In this mode, [TodoComposer] is allowing user to add a new to-do.
  const factory TodoComposerMode.addTodo() = TodoComposerModeAddTodo;

  /// In this mode, [TodoComposer] is showing the to-do user selected.
  const factory TodoComposerMode.viewTodo(Todo selectedTodo) = TodoComposerModeViewTodo;

  /// In this mode, [TodoComposer] is editing the to-do user selected.
  const factory TodoComposerMode.editTodo(Todo todo) = TodoComposerModeEditTodo;
}
